...
## News
- (October 2025) [ParlaCAP v1](https://doi.org/10.23669/1ZTELP) has been published - parliamentary discussions from 28 European parliaments, 8 million speeches, each discussion represented via the Comparative Agendas Project topic (obtained via the [ParlaCAP](https://huggingface.co/classla/ParlaCAP-Topic-Classifier) model) and sentiment (obtained via the [ParlaSent](https://huggingface.co/classla/xlm-r-parlasent) model).
