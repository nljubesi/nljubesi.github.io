...
## News
- (Sepmtember 2025) ParlaSpeech v3 [has been released](http://hdl.handle.net/11356/1833), with four langauges, five annotation layers (three on the spoken modality). The data are also available for search via CLARIN.SI, with a [tutorial available](https://clarinsi.github.io/parlaspeech/concordancer/concordancer-guide.html).
