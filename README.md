...
## News
- (October 2025) [ParlaCAP v1](https://doi.org/10.23669/1ZTELP) has been published - parliamentary discussions from 28 European parliaments, 8 million speeches, each discussion represented via the Comparative Agendas Project topic (obtained from the [ParlaCAP](https://huggingface.co/classla/ParlaCAP-Topic-Classifier) model) and sentiment (obtained from the [ParlaSent](https://huggingface.co/classla/xlm-r-parlasent) model).
- (September 2025) ParlaSpeech v3 [has been released](http://hdl.handle.net/11356/1833), with four langauges, five annotation layers (three on the spoken modality). The data are also available for search via CLARIN.SI, with a [tutorial available](https://clarinsi.github.io/parlaspeech/concordancer/concordancer-guide.html).
